...
export default function Navbar() {
    ...
    return (
        <header className={`${geist.className} fixed left-0 right-0 top-0 z-50 px-7 pt-4`}>
            <motion.div
                layout
                transition={{
                    type: "spring",
                ...
                className="mx-auto flex w-full items-center justify-between border"
            >
                {/* Logo */}
                <a href="/" className="flex shrink-0 items-center gap-3">
                    ...
                    <p className="text-lg font-semibold text-slate-900">OpsellAI</p>
                </a>

                {/* Navigation */}
                <nav className="hidden md:block">
                    <ul className="relative flex h-11 items-center rounded-full px-2">
                        <li className="z-10 flex h-full items-center justify-center px-5 text-sm font-medium text-slate-900">
                            <Link href="#hero">Home</Link>
                        </li>

                        <li className="z-10 flex h-full items-center justify-center px-5 text-sm font-medium text-slate-500 transition hover:text-slate-900">
                ...
                <div className="flex items-center gap-3">
                    <a
                        href="#"
                        className="hidden rounded-full bg-blue-600 px-6 py-2 text-sm font-medium text-white shadow-[0_6px_18px_rgba(37,99,235,0.35)] transition hover:bg-blue-700 md:flex"
                    >
                        Try for free
                    </a>
