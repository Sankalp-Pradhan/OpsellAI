...
export const TimeSavedCard = () => {
  ...
  return (
    <div ref={ref} className="flex h-full w-full w-full">
      <motion.article
        ...
        className="group relative flex h-full w-full flex-col overflow-hidden rounded-3xl border border-emerald-100 bg-white p-6 shadow-2xl transition-shadow md:p-7"
      >
        {/* Ambient glow */}
        ...
        <div className="relative flex items-start justify-between gap-4">
          <div>
            <span className="inline-flex h-7 items-center gap-1.5 rounded-full bg-emerald-100 px-3 text-xs font-medium text-emerald-700">
          ...
          <motion.div
            ...
            className="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-500 shadow-sm"
          >
        ...
        {/* Dynamic content area - grows to match card height */}
        <div className="relative mt-5 flex-1 rounded-2xl border border-emerald-100 bg-emerald-50 p-4 min-h-[180px]">
          <AnimatePresence mode="wait">
              ...
              >
                {TASKS.map((task, index) => (
                  <motion.div
                    ...
                    className="flex items-center justify-between rounded-lg border border-emerald-100 bg-white px-3 py-2 text-xs font-medium text-slate-600 shadow-sm"
                  >
                    <span>{task}</span>
            ...
            {phase === "automated" && (
              ...
              >
                <div className="inline-flex items-center gap-2 rounded-full bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-white shadow-lg">
            ...
            {phase === "dashboard" && (
              ...
              >
                <motion.div
                  ...
                  className="relative flex h-20 w-32 items-center justify-center rounded-xl border border-emerald-200 bg-white ring-4 ring-emerald-500/10"
                >
        ...
        <div className="relative mt-5 flex items-center justify-between gap-3">
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-100 px-3 py-1.5 text-xs font-semibold text-emerald-700"
          >
