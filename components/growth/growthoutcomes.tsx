...
export const GrowthOutcomes = () => {
  return (
    <section className="relative w-full overflow-hidden py-12 md:px-10 md:py-5">
      <div className="pointer-events-none absolute left-1/4 top-1/4 h-[500px] w-[500px] rounded-full bg-gradient-glow-blue opacity-40 blur-3xl" />
      <div className="pointer-events-none absolute bottom-1/4 right-1/4 h-[500px] w-[500px] rounded-full bg-gradient-glow-green opacity-30 blur-3xl" />
